 ...
 */
export function streamScanTags(filePath, openTag, closeTag, onMatch) {
 ...
 */
export function extractImageByIdSync(htmlPath, imageId) {
 ...
 */
export function streamImageScriptsToFile(srcFilePath, destFilePath) {
 ...
 */
export function extractLastDumpScriptSync(filePath) {
...
export function parseImageScripts(html) {
    const imageMap = {};
...
export function parseDumpScript(html) {
...
export function parseDumpScriptAttributes(html) {
...
export function generateImageScriptTag(id, data) {
...
export function getBaseUrlFixScript() {
...
export function generateDumpScriptTag(json, attributes) {
    let attrString = '';
