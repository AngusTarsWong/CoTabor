import { descriptionOfTree as sharedDescriptionOfTree, treeToList, trimAttributes, truncateText, } from '@/shared/extractor';
...
export function descriptionOfTree(tree, truncateTextLength, filterNonTextContent = false, visibleOnly = true) {
    if (!visibleOnly) {
    ...
    return sharedDescriptionOfTree(tree, truncateTextLength, filterNonTextContent, visibleOnly);
}
