...
import { buildYamlFlowFromPlans, fillBboxParam, findAllMidsceneLocatorField, } from '../common';
import { systemPromptToTaskPlanning } from './prompt/llm-planning';
import { extractXMLTag, parseMarkFinishedIndexes, parseSubGoalsFromXML, } from './prompt/util';
import { AIResponseParseError, callAI, safeParseJson, } from './service-caller/index';
 ...
 */
export function parseXMLPlanningResponse(xmlString, modelFamily) {
...
export async function plan(userInstruction, opts) {
        ...
        actions.forEach((action) => {
            ...
            locateFields.forEach((field) => {
                ...
                if (locateResult && modelFamily !== undefined) {
                    ...
                    action.param[field] = fillBboxParam(locateResult, imageWidth, imageHeight, modelFamily);
                }
            });
        });
