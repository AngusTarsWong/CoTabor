...
export function systemPromptToLocateSection(modelFamily) {
...
export const sectionLocatorInstruction = (sectionDescription) => `Find section containing: ${sectionDescription}`;
