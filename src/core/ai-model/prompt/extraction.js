 ...
 */
export function parseXMLExtractionResponse(xmlString) {
    ...
    let data;
    try {
        data = safeParseJson(dataJsonStr, undefined);
    }
    catch (e) {
...
export const extractDataQueryPrompt = (pageDescription, dataQuery) => {
    let dataQueryText = '';
