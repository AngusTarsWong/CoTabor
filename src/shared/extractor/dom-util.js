...
export function isNotContainerElement(node) {
    return (isTextElement(node) ||
        isIconfont(node) ||
        isImgElement(node) ||
...
export function isContainerElement(node) {
 ...
 */
export function generateElementByPoint(center, description, edgeSize = 8) {
 ...
 */
export function generateElementByRect(sourceRect, description, edgeSize = 8) {
    /**
