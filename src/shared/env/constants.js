...
export const INSIGHT_MODEL_CONFIG_KEYS = {
...
export const PLANNING_MODEL_CONFIG_KEYS = {
...
export const DEFAULT_MODEL_CONFIG_KEYS = {
...
export const DEFAULT_MODEL_CONFIG_KEYS_LEGACY = {
    modelName: MIDSCENE_MODEL_NAME,
    /**
