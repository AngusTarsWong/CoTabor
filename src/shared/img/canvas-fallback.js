 ...
 * Resize an image
 */
export function canvasResize(image, newWidth, newHeight, _filter) {
    const canvas = document.createElement('canvas');
 ...
 * Crop an image
 */
export function canvasCrop(image, x1, y1, x2, y2) {
    const width = x2 - x1;
    const height = y2 - y1;
    const canvas = document.createElement('canvas');
    canvas.width = width;
 ...
 */
export function canvasPaddingRight(image, padding, color) {
 ...
 */
export function canvasPaddingBottom(image, padding, color) {
 ...
 */
export function canvasPaddingUniform(image, padding, color) {
 ...
 */
export function canvasPaddingLeft(image, padding, color) {
    const newWidth = image.get_width() + padding;
    const height = image.get_height();
    const canvas = document.createElement('canvas');
    canvas.width = newWidth;
 ...
 */
export function canvasPaddingTop(image, padding, color) {
    const width = image.get_width();
    const newHeight = image.get_height() + padding;
    const canvas = document.createElement('canvas');
    canvas.width = width;
 ...
 */
export function canvasWatermark(base, overlay, x, y) {
    const canvas = document.createElement('canvas');
