...
import { forceChromeSelectRendering as applyChromeSelectRendering, forceClosePopup, } from './base-page';
...
export class PuppeteerAgent extends PageAgent {
    constructor(page, opts) {
        if (!page) {
            throw new Error('[midscene] PuppeteerAgent requires a valid Puppeteer page instance. Please make sure to pass a valid page object.');
        }
        ...
        if (forceChromeSelectRendering) {
            ...
            if (puppeteerVersion && !semver.gte(puppeteerVersion, '24.6.0')) {
                console.warn(`[midscene:error] forceChromeSelectRendering requires Puppeteer > 24.6.0, but current version is ${puppeteerVersion}. This feature may not work correctly.`);
            }
